...
class RekapSkor implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    protected $getPoolRespon;
    ...
    {
        $this->getPoolRespon = PoolRespon::orderby('created_at')->get()->unique('npp_penilai_dinilai')->toArray();
    }
    ...
    {
        $chunks        = array_chunk($this->getPoolRespon, 50);
        $bobot_penilai = 0;
        $collection    = [];
        $aspek_k       = 0;  // 3
        $aspek_s       = 0;  // 2
