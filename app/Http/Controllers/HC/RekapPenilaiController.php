...
class RekapPenilaiController extends Controller
{
    ...
    {
        $dinilai = Cache::remember('dinilai', now()->addMinutes(60), function () {
            return RekapPenilai::with(['identitas_dinilai'])
                       ->select()
    ...
    public function checkStatus(Request $request)
    {
        ...
        $sheet_id = config('google.config.sheet_response_id', '');
    ...
    public function exportPersonalRawXlsx()
    {
        ...
        return Excel::download(new RekapPenilaiPersonalRawExport, 'FinalSkorDp3Raw-' . $nows, \Maatwebsite\Excel\Excel::XLSX);
    }
    ...
    public function exportPersonalRawCsv()
    {
        ...
        return Excel::download(new RekapPenilaiPersonalRawExport, 'FinalSkorDp3Raw-' . $nows, \Maatwebsite\Excel\Excel::CSV);
    }
    ...
    public function exportPersonalXlsx()
    {
        ...
        return Excel::download(new RekapPenilaiPersonalExport, 'FinalSkorDp3-' . $nows, \Maatwebsite\Excel\Excel::XLSX);
    }
    ...
    public function exportPersonalCsv()
    {
        ...
        return Excel::download(new RekapPenilaiPersonalExport, 'FinalSkorDp3-' . $nows, \Maatwebsite\Excel\Excel::CSV);
    }
    ...
    public function exportRawXlsx()
    {
        ...
        return Excel::download(new RekapPenilaiRawExport, 'Dp3Raw-' . $nows, \Maatwebsite\Excel\Excel::XLSX);
    }
    ...
    public function exportRawCsv()
    {
        ...
        return Excel::download(new RekapPenilaiRawExport, 'Dp3Raw-' . $nows, \Maatwebsite\Excel\Excel::CSV);
    }
    ...
    public function exportXlsx()
    {
        ...
        return Excel::download(new RekapPenilaiExport, 'Dp3Group' . $nows, \Maatwebsite\Excel\Excel::XLSX);
    }
    ...
    public function exportCsv()
    {
        ...
        return Excel::download(new RekapPenilaiExport, 'Dp3Group' . $nows, \Maatwebsite\Excel\Excel::CSV);
    }
    ...
    public function index_personal()
    {
        // New
        // $check = FinalDp3::get();
        $check = Cache::remember('check', now()->addMinutes(60), function () {
            return FinalDp3::get();
        });
        // dd($check);
        if (count($check) < 1) {
        ...
        $karyawans = Cache::remember('karyawans', now()->addMinutes(60), function () {
            return RelasiKaryawan::select('id', 'npp_karyawan')->get();
        });
        $finalData   = collect([]);
        $npp         = '';
        $nama        = '';
    ...
    public function exportPersonalCompleteXlsx()
    {
        ...
        return Excel::download(new RekapPenilaiPersonalCompleteExport, 'FinalSkorDp3-Complete' . $nows, \Maatwebsite\Excel\Excel::XLSX);
    }
    ...
    public function exportPersonalCompleteFullColXlsx()
    {
        ...
        return Excel::download(new RekapPenilaiPersonalCompleteFullColExport, 'FinalSkorDp3FullCol-Complete' . $nows, \Maatwebsite\Excel\Excel::XLSX);
    }
