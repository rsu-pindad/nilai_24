...
class RekapPenilaiController extends Controller
{
    ...
    private function hitungRelasi($relasi)
    {
        $getPoolRespon = [];
        if ($relasi == 'self') {
            $getPoolRespon = PoolRespon::where('relasi', 'self')->orderby('npp_dinilai')->get()->unique('npp_penilai_dinilai');
        } elseif ($relasi == 'atasan') {
            $getPoolRespon = PoolRespon::where('relasi', 'atasan')->orderby('npp_dinilai')->get()->unique('npp_penilai_dinilai');
        } elseif ($relasi == 'rekanan') {
            $getPoolRespon = PoolRespon::where('relasi', 'rekanan')->orderby('npp_dinilai')->get()->unique('npp_penilai_dinilai');
        } elseif ($relasi == 'all') {
            $getPoolRespon = PoolRespon::orderby('npp_dinilai')->get()->unique('npp_penilai_dinilai');
        }
