...
class RekapPenilaiPersonalCompleteFullColExport implements FromQuery, WithHeadings, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            ...
            'rata-rata_skor_dp3',
            'max_skor_dp3_markup',
            'point_skor_dp3_markup',
            'kriteria_skor_dp3_markup'
        ];
    }
}
