...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('hc')->group(function () {
        ...
        Route::controller(DetailSkorDP3Controller::class)->group(function () {
            Route::get('/dp3/total/{dinilai}/detail/', 'index')->name('dp3-total-detail');
            Route::get('/dp3/total/{dinilai}/detail-pdf/', 'viewPdf')->name('dp3-total-detail-pdf');
            Route::get('/dp3/total/{dinilai}/detail-pdf-simple/', 'viewPdfSimple')->name('dp3-total-detail-pdf-simple');
        });
        // Route::get('/penilai-rekap/detail{dinilai?}', 'detailNilai')->name('penilai-rekap-detail-relasi');
