            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex bd-highlight flex-row">
                  <div class="px-2">
                    <button id="btnRekapPerilakuModal"
                            type="button"
                  ...
                  <div class="px-2">
                    <div class="btn-group mr-2"
                      ...
                      <div class="dropdown-menu">
                        ...
                        <form action="{{ route('penilai-rekap-personal-export-raw-xlsx') }}"
                              method="post"
                        ...
                        <form action="{{ route('penilai-rekap-personal-export-raw-csv') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
                        ...
                        <form action="{{ route('penilai-rekap-personal-export-xlsx') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
                        ...
                        <form action="{{ route('penilai-rekap-personal-export-csv') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
                        ...
                        <form action="{{ route('penilai-rekap-personal-complete-export-xlsx') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
                        ...
                        <form action="{{ route('penilai-rekap-personal-complete-full-col-export-xlsx') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
                          @csrf
                          <button type="submit"
                                  class="btn btn-sm">(full) format (.xlsx)
                          </button>
                        </form>
                      </div>
                    </div>
                  ...
                  <div class="px-2">
                    <div class="btn-group mr-2"
                      ...
                      <div class="dropdown-menu">
                        ...
                        <form action="{{ route('penilai-rekap-personal-word-doc') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
                        ...
                        <form action="{{ route('penilai-rekap-personal-template-pdf') }}"
                              method="post"
                              class="dropdown-item btn btn-outline-info"
                              enctype="multipart/form-data"
                              target="_blank">
  ...
  <script>
    $(document).ready(function(e) {
      ...
      $('#btnRekapPerilakuModal').on('click', function(ev) {
        ...
        alertswal(
          'anda yakin', 'anda melakukan rekap penilaian akhir', 'warning', 'iya'
        );
      });
    });
  </script>
