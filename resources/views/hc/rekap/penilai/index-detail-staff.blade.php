...
<head>
    ...
    <title>Rekap Personal Staff</title>
                ...
                <table class="table table-sm table-responsive table-striped table-bordered table-hover"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="pp1_sum" class="ppm">{{ round($data_penilai->kerjasama_bobot_aspek, 2) * 100 }}
                            </td>
                        </tr>
                        <tr>
                            <td>Komunikasi</td>
                        ...
                        <tr>
                            ...
                            <td id="pp3_sum" class="ppm">{{ round($data_penilai->absensi_bobot_aspek, 2) * 100 }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td id="pp5_sum" class="ppm">{{ round($data_penilai->etika_bobot_aspek, 2) * 100 }}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
