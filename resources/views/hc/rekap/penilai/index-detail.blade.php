...
<head>
    ...
    <title>Rekap Personal {{ $data_penilai->relasi_karyawan->npp_karyawan }} -
        {{ $data_penilai->relasi_karyawan->nama_karyawan ?? '' }}
    </title>
            ...
            <div class="card">
                <div class="card-header">
                    <a href="#" class="brand-link text-muted">
                        ...
                        @isset($marks)
                            Hasil Personal - {{ $data_penilai->relasi_karyawan->npp_karyawan ?? '' }} -
                            {{ $data_penilai->relasi_karyawan->nama_karyawan ?? '' }}
                        @else
                            Staff
                        @endisset
                    ...
                    <table class="table table-sm table-responsive table-striped table-bordered table-hover"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="pp1_sum" class="ppm">
                                    {{ round($data_penilai->kerjasama_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                <td>Komunikasi</td>
                                <td id="pp2">{{ $data_penilai->relasi_respon->komunikasi }}</td>
                                <td id="ppm2">{{ $data_penilai->komunikasi_bobot_aspek }}</td>
                                <td id="pp2_sum" class="ppm">
                                    {{ round($data_penilai->komunikasi_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="pp3_sum" class="ppm">
                                    {{ round($data_penilai->absensi_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="pp4_sum" class="ppm">
                                    {{ round($data_penilai->integritas_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                <td>Etika</td>
                                <td id="pp5">{{ $data_penilai->relasi_respon->etika }}</td>
                                <td id="ppm5">{{ $data_penilai->etika_bobot_aspek }}</td>
                                <td id="pp5_sum" class="ppm">
                                    {{ round($data_penilai->etika_bobot_aspek, 2) * 100 }}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                            ...
                            <tr>
                                ...
                                <td id="sp1_sum" class="spm">
                                    {{ round($data_penilai->goal_kinerja_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="sp2_sum" class="spm">
                                    {{ round($data_penilai->error_kinerja_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="sp3_sum" class="spm">
                                    {{ round($data_penilai->proses_dokumen_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td id="sp5_sum" class="spm">
                                    {{ round($data_penilai->proses_inisiatif_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td id="kp1_sum" class="kpm">
                                    {{ round($data_penilai->strategi_perencanaan_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="kp2_sum" class="kpm">
                                    {{ round($data_penilai->strategi_pengawasan_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="kp3_sum" class="kpm">
                                    {{ round($data_penilai->strategi_inovasi_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                <td>Kepemimpinan</td>
                                <td id="kp4">{{ $data_penilai->relasi_respon->kepemimpinan }}</td>
                                <td id="kpm4">{{ $data_penilai->kepemimpinan_bobot_aspek }}</td>
                                <td id="kp4_sum" class="kpm">
                                    {{ round($data_penilai->kepemimpinan_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="kp5_sum" class="kpm">
                                    {{ round($data_penilai->membimbing_membangun_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td id="kp6_sum" class="kpm">
                                    {{ round($data_penilai->pengambilan_keputusan_bobot_aspek, 2) * 100 }}</td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                ...
                                <td id="totalSumNilai">
                                    {{ round(
                                        ($data_penilai->sum_nilai_k_bobot_aspek +
                                            ...
                                            $data_penilai->sum_nilai_p_bobot_aspek) *
                                            100,
                                        3,
                                    ) }}
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ round($data_penilai->sum_nilai_dp3 * 100, 3) }}
                                    {{ '(' . $bobot_penilai . ')' }}
                                </td>
                            </tr>
                            @isset($avg_penilai)
