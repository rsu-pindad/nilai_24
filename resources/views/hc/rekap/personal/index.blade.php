                                        ...
                                        <tbody>
                                            @foreach ($rekap_personal_data as $rp)
                                                <tr>
                                                    ...
                                                    <td>{{ $rp->sum_rekap }}</td>
                                                    <td>
                                                        <button type="button" class="btn btn-info btn-sm btn-personal"
                                                            data-toggle="modal" data-target="#staticBackdrop"
                                                            data-id="{{ $rp->id }}">
                                                            <i class="far fa-eye"></i>
                                                        </button>
                                                        <a href="/rekap/detail-personal?detail={{ $rp->id }}"
    ...
    <script>
        $(document).ready(function() {
                ...
                $.when(showDetail(id))
                    .then(function(sd) {
                            ...
                            $.when(showDetailPenilai(sd.karyawan_atasan[0].npp_atasan))
                                .then(function(sdp) {
                                        const url = '/rekap/hasil-personal/status?dinilai=' + sd
                                            .identitas_dinilai.npp_karyawan + '&penilai=' + sdp.id;
                                        const urlFollowUp = '/rekap/hasil-personal/follow-up?dinilai=' + sd
                                            .identitas_dinilai.npp_karyawan + '&penilai=' + sdp
                                            .npp_karyawan;
                                        ...
                                        `<td>
                                            ...
                                            $('#penilai_atasan').append(html).ready(function(e) {
                                                $('.btnFollowUp').on('click', function(e) {
                                                    ...
                                                    var url = $(this).attr(
                                                        'data-url');
                                                    var npp_penilai = $(this).attr(
                                                        'data-npp-penilai');
                                                    var npp_dinilai = $(this).attr(
                                                        'data-npp-dinilai');
                            ...
                            $.when(showDetailSelevelAtasan(sd.identitas_dinilai.id, sd.karyawan_atasan[0]
                                    .npp_atasan))
                                .then(function(sdsa) {
                                        $(sdsa).each(function(i, items) {
                                            console.log(items);
                                            const url = '/rekap/hasil-personal/status?dinilai=' + sd
                                                .identitas_dinilai.npp_karyawan + '&penilai=' +
                                                items.parent_atasan.id;
                                            const urlFollowUp =
                                                '/rekap/hasil-personal/follow-up?dinilai=' + sd
                                                .identitas_dinilai.npp_karyawan + '&penilai=' +
                                                items.parent_atasan.npp_karyawan;
                                ...
                                `;
                                                ...
                                                $(html).insertAfter('#penilai_atasan')
                                                    .ready(function(e) {
                                                        $('.btnFollowUp').on('click',
                                                            function(e) {
                                                                e.preventDefault();
                                                                var url = $(this)
                                                                    .attr(
                            ...
                            $(sd.karyawan_staff).each(function(i, items) {
                                ...
                                `;
                                                ...
                                                $(html).insertAfter('#penilai_selevel')
                                                    .ready(function(e) {
                                                        $('.btnFollowUp').on('click',
                                                            function(e) {
                                                                e.preventDefault();
            ...
            async function showForm(response) {
                ...
                if (response.identitas_dinilai.level_jabatan == 'IA' || response.identitas_dinilai
                    .level_jabatan == 'IC') {
                    $("#ket_kp_1").html('a (25%)');
                    ...
                    aspek_3 = 0.50;
                } else if (response.identitas_dinilai.level_jabatan == 'II' || response.identitas_dinilai
                    .level_jabatan == 'IINS') {
                    $("#ket_kp_1").html('a (25%)');
            ...
            async function showDetailSelevelAtasan(id_dinilai, npp_atasan_dinilai) {
                return $.ajax({
                    url: '/rekap/hasil-personal/selevel?dinilai=' + id_dinilai + '&atasan=' +
                        npp_atasan_dinilai,
                    type: 'get',
                    dataType: 'json',
                });
            ...
            async function statusHasil(dinilai, penilai) {
                return $.getJSON(`/rekap/hasil-personal/status?dinilai='+${dinilai}+'&penilai='+${penilai}`,
                    function(i, items) {
                        return items;
                    }
                );
