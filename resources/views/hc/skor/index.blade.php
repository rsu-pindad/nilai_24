                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-2">
                                                        <div class="btn-toolbar d-flex justify-content-around"
                                                            role="toolbar" arua-label="grup satu">
                                                            <div class="btn-group mr-2" role="group"
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    data-skors="{{ $skor['skor'] }}" data-bs-toggle="modal"
...
@push('modals')
    <!-- Modal -->
    <div class="modal fade" id="formTambahSkor" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="formTambahSkorLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <button class="btn btn-primary" id="btnTambahSkor" type="submit"><i
                                class="far fa-save px-2"></i>Simpan</button>
                    </form>
                </div>
...
@push('modals')
    <!-- Modal -->
    <div class="modal fade" id="formTambahAspek" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="formTambahAspekLabel" aria-hidden="true">
...
@push('modals')
    <!-- Modal -->
    <div class="modal fade" id="formTambahIndikator" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="formTambahIndikatorLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="select_aspek">Pilih Aspek</label>
                                <select class="form-control edit_select_aspek" id="select_aspek" name="select_aspek"
                                    required>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="select_indikator">Pilih indikator</label>
                                <select class="form-control edit_select_indikator" id="select_indikator"
                                    name="select_indikator" required>
                                    <option disabled selected>pilih aspek dahulu</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-3 mb-3">
                                <label for="input_skor">Skor</label>
                                <input type="number" class="form-control edit_input_skor" id="input_skor"
                                    name="input_skor" required>
                            </div>
                        </div>
                        <button class="btn btn-primary" id="btnEditSkor" type="submit"><i
                                class="far fa-edit px-2"></i>Edit</button>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="closeLihatEdit">tutup</button>
                </div>
            </div>
        </div>
    </div>
