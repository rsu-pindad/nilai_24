              ...
              <div class="card-header">
                <div class="d-flex bd-highlight flex-row">
                  <div class="bd-highlight p-2">
                    <button id="btnPullResponse"
                            type="button"
                            class="btn btn-secondary">
                      <i class="fas fa-arrow-down px-2"></i>Ambil Response Form
                    </button>
                  </div>
                  <div class="bd-highlight p-2">
                    <form action="{{ route('skor-reset') }}"
                          method="POST">
                      @csrf
                      <button type="submit"
...
@pushOnce('modals')
  <!-- Modal -->
  <div id="lihatProfileModal"
       class="modal fade"
       tabindex="-1"
       aria-labelledby="lihatProfileModal"
       aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <p id="lihatProfileModalLabel"
             class="modal-title h4"></p>
        </div>
        <div id="setProfile"
             class="modal-body">
        ...
        <div class="modal-footer">
          <button id="exitProfilePenilaiModal"
                  type="button"
                  class="btn btn-secondary"
  ...
  <!-- Modal -->
  <div id="lihatResponseModal"
       class="modal fade"
       tabindex="-1"
       aria-labelledby="lihatResponseModal"
       aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <p id="lihatResponseModalLabel"
             class="modal-title h4"></p>
        </div>
        <div id="setResponse"
             class="modal-body">
...
@pushOnce('scripts')
  ...
  <script>
    ...
    $('.lihatResponse').one('click', function(e) {
      e.preventDefault();
  ...
  <script>
    $(document).ready(function(e) {
      ...
      $('#btnPullResponse').on('click', function(ev) {
        ...
        alertswal(
          'anda yakin', 'anda melakukan penarikan data pada sheet google form response', 'info', 'Iya'
        );
      });
