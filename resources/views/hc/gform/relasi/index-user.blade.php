                                        ...
                                        @foreach ($user_data as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('relasi-user-reset-password', $user->id) }}"
                                                        method="Post">
                                                        @csrf
                                                        @method('PUT')
                                                    ...
                                                    <button type="button" class="btn btn-outline-info btn-sm resetUser"
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control edit_input_npp" id="input_npp" name="input_npp"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control edit_input_email" id="input_email"
                                    name="input_email" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="input_phone">Phone</label>
                                <input type="email" class="form-control edit_input_phone" id="input_phone"
                                    name="input_phone" required>
                            </div>
                        </div>
                        <button class="btn btn-primary" id="btnEditUser" type="submit"><i
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control input_password" id="input_password"
                                    name="input_password" placeholder="masukan password" required>
                            </div>
                        </div>
                        <button class="btn btn-danger" id="btnResetUser" type="submit"><i
                                class="fas fa-redo-alt p-1"></i>Reset</button>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="closeLihatReset">tutup</button>
                </div>
            </div>
        </div>
    </div>
