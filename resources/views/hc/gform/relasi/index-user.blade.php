                            ...
                            <table class="table table-striped table-bordered" id="tabelUser">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user->no_hp }}</td>
                                        <td>
                                            <button type="button" class="btn btn-outline-info btn-sm editUser" data-id="{{ $user->id }}" data-npp="{{ $user->npp }}" data-nama="{{ $user->nama }}" data-email="{{ $user->email }}" data-jabatan="{{ $user->jabatan }}" data-phone="{{ $user->no_hp }}" data-bs-toggle="modal" data-bs-target="#editUser">
                                                <i class="fas fa-edit"></i>Edit
                                            </button>
                                            <form action="{{ route('relasi-user-reset-password', $user->id) }}" method="Post">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-outline-warning btn-sm" onclick="return confirm('anda yakin password akan di reset?')">
                                                    <i class="fas fa-sync-alt p-1"></i>Reset Password
                                                </button>
                                            </form>
                                            <button type="button" class="btn btn-outline-info btn-sm resetUser" data-id="{{ $user->id }}" data-bs-toggle="modal" data-bs-target="#resetUser">
                ...
                <form>
                    ...
                    <div class="form-row">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control edit_input_nama" id="input_jabatan" name="input_jabatan" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
